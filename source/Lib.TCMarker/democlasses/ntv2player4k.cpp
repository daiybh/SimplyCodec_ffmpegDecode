...
void NTV2Player4K::PlayFrames (void)
{
	...
	//	Initialize & start AutoCirculate...
	{
		...
		mDevice.AutoCirculateInitForOutput (mChannel, numberOfACFramesPerChannel,
											mAudioSystem, AUTOCIRCULATE_WITH_RP188,
											1,
											(mChannel < 4)?0:numberOfACFramesPerChannel,
											(mChannel < 4)?(numberOfACFramesPerChannel-1):(numberOfACFramesPerChannel*2-1));
	}
