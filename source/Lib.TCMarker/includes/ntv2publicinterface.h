		...
		**/
		NTV2_STRUCT_BEGIN (AUTOCIRCULATE_STATUS)
				NTV2_HEADER				acHeader;					///< @brief	The common structure header -- ALWAYS FIRST!
					...
					LWord					acActiveFrame;				///< @brief	Current frame actually being captured/played when AutoCirculateGetStatus called	FIXFIXFIX	CHANGE TO ULWord??
					ULWord64				acRDTSCStartTime;			///< @brief	Performance counter when AutoCirculateStart called
					ULWord64				acAudioClockStartTime;		///< @brief	Register 28 when AutoCirculateStart called
					ULWord64				acRDTSCCurrentTime;			///< @brief	Performance counter at moment AutoCirculateGetStatus called
					ULWord64				acAudioClockCurrentTime;	///< @brief	Register 28 with wrap logic
					ULWord					acFramesProcessed;			///< @brief	Total number of frames successfully processed since AutoCirculateStart called
					ULWord					acFramesDropped;			///< @brief	Total number of frames dropped since AutoCirculateStart called
					ULWord					acBufferLevel;				///< @brief	Number of buffered frames in driver ready to capture or play
					ULWord					acOptionFlags;				///< @brief	AutoCirculate options (e.g., AUTOCIRCULATE_WITH_RP188, etc.)
