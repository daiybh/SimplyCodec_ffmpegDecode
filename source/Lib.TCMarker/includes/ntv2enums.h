...
#define AJA_NTV2_SDK_BUILD_NUMBER		40			///< @brief	The SDK build number, an unsigned decimal integer.
#define AJA_NTV2_SDK_BUILD_DATETIME		"Wed Jan 24 18:02:37 UTC 2018"		///< brief	The date and time the SDK was built, in this format: "MM/DD/YYYY +8:hh:mm:ss"
