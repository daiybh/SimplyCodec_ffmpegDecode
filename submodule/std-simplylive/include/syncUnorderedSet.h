...
template <class K, class Hasher = std::hash<K>, class Keyeq = std::equal_to<K>>
class SyncUnorderedSet
{
public:
...
private:
	std::unordered_set<K, Hasher, Keyeq>	m_set;
	RWLocker								m_lock;
};
